...
/**
 * LocalesMantenimientoSearch represents the model behind the search form of `app\models\LocalesMantenimiento`.
 */
class LocalesMantenimientoSearch extends LocalesMantenimiento
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LocalesMantenimiento::find();
