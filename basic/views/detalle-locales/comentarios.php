            ...
            if(empty($comentarios)){
                ...
                foreach($comentarios as $comentario){
                    ...
                    foreach($comentario as $key => $value)
                    {
                        ...
                        <td ><a href="<?= Url::toRoute(['detalle-locales/responder', 'idComentario'=>$comentario->id]);?>" class="btn pl-2 pr-2 mb-0 btn-default">Responder</a></td>
                        ...
                        <td ><?= Html::a("Denunciar", ['detalle-locales/denunciarcomentario', 'idComentario' => $comentario->id] , ['class' => 'btn btn-success']) ?></td>
                    </tr>
                    <?php
                }
            }
